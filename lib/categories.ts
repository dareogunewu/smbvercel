...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "Fees & Charges",
    icon: "💳",
    keywords: ["payment - thank you", "paiement - merci", "fees", "charges"],
  },
  {
  ...
  },
  {
    ...
    icon: "❤️",
    keywords: ["charity", "donation", "donate", "nonprofit", "foundation", "giving", "tithe.ly"],
  ...
  },
  {
    ...
    name: "Internet",
    icon: "🌐",
    keywords: ["internet", "broadband", "isp", "comcast", "spectrum", "rogers ******0", "bell fibe"],
    mccCodes: [4899],
  },
  {
    id: "interest_expense",
    ...
    icon: "📈",
    keywords: ["interest", "finance charge", "loan interest", "purchase interest"],
  },
  {
    id: "meals_entertainment",
    name: "Meals & entertainment",
    icon: "🍽️",
    keywords: ["restaurant", "dining", "meal", "lunch", "dinner", "starbucks", "coffee", "food", "kitchen", "cafe", "bistro", "grill", "eatery", "bar", "pub", "brewery", "lcbo", "paypal *doordash", "jack astor", "thai room", "le lert", "ameen's kitchen"],
  ...
  },
  {
    ...
    name: "Training",
    icon: "📚",
    keywords: ["training", "course", "seminar", "workshop", "education", "learning", "digital product perth"],
  ...
  },
  {
    ...
    name: "Travel",
    icon: "✈️",
    keywords: ["airfare", "airline", "flight", "paypal *uber", "paypal *ubertrip", "lyft", "taxi", "transit", "via rail", "amtrak", "train", "rail", "bus", "greyhound", "megabus", "air can*", "lne railway", "www.heathrowexpress", "www.flighthub.com"],
  ...
  },
  {
    ...
    name: "Hotel",
    icon: "🏨",
    keywords: ["hotel", "motel", "airbnb", "booking", "expedia", "resort", "lodge", "inn", "advantage hotels"],
  ...
  },
  {
    ...
    name: "Groceries",
    icon: "🛒",
    keywords: ["grocery", "supermarket", "walmart", "costco wholesale", "loblaws", "sobeys", "metro", "food basics", "oyato food african"],
  ...
  },
  {
    ...
    name: "Medical",
    icon: "🏥",
    keywords: ["medical", "doctor", "clinic", "hospital", "pharmacy", "prescription", "health", "shoppers drug mart"],
  ...
  },
  {
    ...
    name: "Shopping",
    icon: "🛍️",
    keywords: ["amazon", "shopping", "retail", "store", "online", "moores clothing", "uniqlo", "bluenotes"],
  ...
  },
  {
    ...
    name: "Car wash",
    icon: "🚿",
    keywords: ["car wash", "wash", "detailing", "crosstown car wash"],
    mccCodes: [7542],
  },
  {
    id: "haircut",
