...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function bt(a10) {
        let b2 = S.next();
        return (Object.entries({ "Strict-Transport-Security": "max-age=31536000; includeSubDomains", "X-Frame-Options": "DENY", "X-Content-Type-Options": "nosniff", "X-XSS-Protection": "1; mode=block", "Referrer-Policy": "strict-origin-when-cross-origin", "Permissions-Policy": "camera=(), microphone=(), geolocation=(), interest-cohort=()", "Content-Security-Policy": "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https://api2.bankstatementconverter.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'" }).forEach(([a11, c2]) => {
          b2.headers.set(a11, c2);
        }), "http" === a10.headers.get("x-forwarded-proto")) ? S.redirect(`https://${a10.headers.get("host")}${a10.nextUrl.pathname}`, 301) : b2;
      }
      ...
      let bv = { ...f }, bw = bv.middleware || bv.default, bx = "/middleware";
